...
static struct inode *
myfs_make_inode(struct super_block *sb, int mode)
{
...
static void
myfs_put_super(struct super_block *sb)
{
...
static int
myfs_fill_sb(struct super_block *sb, void *data, int silent)
{
...
myfs_mount(struct file_system_type *type, int flags,
