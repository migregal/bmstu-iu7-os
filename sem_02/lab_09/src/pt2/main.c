...
static int seq_show(struct seq_file *m, void *v)
{
    ...
    tmp[0] = '\0';
    cur_pos = 0;
    printk(KERN_INFO "WQ: show is called\n");
...
{
    printk(KERN_INFO "WQ: open is called\n");
...
{
    printk(KERN_INFO "WQ: release is called\n");
...
int init_module(void)
{
    ...
    {
        freemem();
        printk(KERN_ERR "WQ: error during file creation\n");
