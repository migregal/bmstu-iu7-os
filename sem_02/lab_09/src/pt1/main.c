...
static int seq_show(struct seq_file *m, void *v)
{
    ...
    tmp[0] = '\0';
    cur_pos = 0;
    printk(KERN_INFO "TASKLET: show is called\n");
...
{
    printk(KERN_INFO "TASKLET: open is called\n");
...
{
    printk(KERN_INFO "TASKLET: release is called\n");
...
int init_module(void)
{
    ...
    {
        freemem();
        printk(KERN_ERR "TASKLET: error during file creation\n");
